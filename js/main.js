$(document).ready(function() {
  ...
  var cheque_right =
    $(window).width() - (cheque_wrap.offset().left + cheque_wrap.outerWidth());
  ...
  $(window).resize(function() {
    ...
    cheque_right =
      $(window).width() -
      (cheque_wrap.offset().left + cheque_wrap.outerWidth());
  });

  $(window).scroll(function() {
    var first_value =
      $(window).scrollTop() > $(".cart-inner").offset().top - 30;
    var second_value =
      $(window).scrollTop() <
      cheque_wrap.offset().top +
        (cheque_wrap.outerHeight() - cheque.outerHeight()) -
        90;
